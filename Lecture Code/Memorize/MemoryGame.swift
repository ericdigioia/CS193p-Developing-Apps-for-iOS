...
struct MemoryGame<CardContent> where CardContent: Equatable {
    ...
    // returns the index of the only face up card. Nil otherwise
    ...
    struct Card: Identifiable {
        ...
        let content: CardContent // a type to be defined in the declaration of MemoryGame
    }
}

// Returns the element if there is only one in the array, nil otherwise
extension Array {
